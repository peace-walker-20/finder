...
def runexp(duration,experiment_id,enc_key,secret,enc_table_name,input_path,max_rows,output_path,opt1_enabled,opt2_enabled):
    ...
    db_port = DB_PORT
    # TODO -Xmx64g should be changed according to the experiment environment
...
opt1_enabled = 0 # optimization 1: Per epoch max value counter. 0 for disable, 1 for enable
opt2_enabled = 0 # optimization 2: Per epoch and per location max value counter. 0 for disable, 1 for enable

# TODO: Change to your local env
in_path = "/home/ubuntu/Workspace/wifi_data/"
