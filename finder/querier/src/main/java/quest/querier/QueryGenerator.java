...
public class QueryGenerator {
    ...
    private static String crowdFlowQueryTemplate = "SELECT encl FROM %s WHERE %s;";
    ...
    public String generateCrowdFlowEncQuery(Timestamp queryStartTimeTs, Timestamp queryEndTimeTs){
        ...
        String crowdFlowQuery = String.format(crowdFlowQueryTemplate, encTableName, conditionsStr);
        return crowdFlowQuery;
    }
    ...
    public static void main(String[] args) throws IOException{
        ...
        EncDataAnalyzer encDataAnalyzer = new EncDataAnalyzer("questk",
                                                              "questsecret");
